...
public class FadeText : MonoBehaviour
{
	...
	protected virtual void Start()
	{
		...
		m_TextToFade		= GetComponent<Text>();
		m_ColorFade			= m_TextToFade.color;
	...
	void Update()
    {
		...
		m_TextToFade.color = m_ColorFade;
